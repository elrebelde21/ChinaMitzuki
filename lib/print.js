...
console.log(`┏┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅┅•
${chalk.bold.greenBright('✪▸▸')} ${chalk.bold.magenta('%s')} ${chalk.bold.greenBright('◂◂✪')} 
...
me + ' ⇢ ' + (conn.user.name == undefined ? '' : ' ~' + conn.user.name) + `${conn.user.jid == global.conn.user.jid ? '' : ' ⇢ (𝘚𝘶𝘣-𝘉𝘰𝘵)'}`,
